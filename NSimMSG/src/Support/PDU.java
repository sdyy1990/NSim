...
public abstract class PDU {
	...
	public abstract Coordinate getdestCoor() ;
...
//		routehistory += name;
		//if (routehistory.length()> 600) {
//			System.out.println(this.getdestid()+" "+this.getsrcid());
			//System.out.println(routehistory);
		//}
...
//		return Integer.toString(linkcount);
//	}
	public int pathtoken = -1;
	public void setpathtoken(int k) { pathtoken =k;}
}
